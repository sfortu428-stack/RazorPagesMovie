            ...
            serviceProvider.GetRequiredService<DbContextOptions<RazorPagesMovieContext>>()))
        {
            ...
            if (!context.Movie.Any())
            {
                ...
                context.Movie.AddRange(
                    new Movie { Title = "When Harry Met Sally", ReleaseDate = new DateTime(1989, 2, 12), Genre = "Romantic Comedy", Price = 7.99M, Rating = "PG", DirectorId = robReiner.Id, ActorId = meg.Id, ImageUrl = "https://example.com/whenharrymetsally.jpg" },
                    new Movie { Title = "Inception", ReleaseDate = new DateTime(2010, 7, 16), Genre = "Sci-Fi", Price = 9.99M, Rating = "PG", DirectorId = moriswiSimon.Id, ActorId = leo.Id, ImageUrl = "https://example.com/inception.jpg" },
                    new Movie { Title = "E.T. the Extra-Terrestrial", ReleaseDate = new DateTime(1982, 6, 11), Genre = "Science Fiction", Price = 7.99M, Rating = "PG", DirectorId = leratoLee.Id, ActorId = meg.Id, ImageUrl = "https://example.com/et.jpg" },
                    new Movie { Title = "Interstellar", ReleaseDate = new DateTime(2014, 11, 7), Genre = "Science Fiction", Price = 12.99M, Rating = "PG", DirectorId = lucyMmasa.Id, ActorId = matthew.Id, ImageUrl = "https://example.com/interstellar.jpg" },
                    new Movie { Title = "Pulp Fiction", ReleaseDate = new DateTime(1994, 10, 14), Genre = "Crime", Price = 8.99M, Rating = "PG", DirectorId = mphoNkuna.Id, ActorId = samuel.Id, ImageUrl = "https://example.com/pulpfiction.jpg" },
                    new Movie { Title = "Django Unchained", ReleaseDate = new DateTime(2012, 12, 25), Genre = "Western", Price = 11.99M, Rating = "PG", DirectorId = mothibaFortunate.Id, ActorId = jamie.Id, ImageUrl = "https://example.com/django.jpg" }
                );
                context.SaveChanges();
            }
        }
